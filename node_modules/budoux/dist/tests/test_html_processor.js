...
function getBlocks(html) {
    const document = win_js_1.win.document;
    (0, dom_js_1.setInnerHtml)(document.body, html);
...
describe('HTMLProcessor.applyToElement.separator.node', () => {
    it('should clone separator element deeply', () => {
        const doc = win_js_1.win.document;
        (0, dom_js_1.setInnerHtml)(doc.body, '<div>今日は良い天気です</div>');
